  ...
  return (
    <Container className="py-12">
      <div className="max-w-2xl mx-auto text-center space-y-6">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white">About Us</h1>
        <p className="text-slate-400 text-lg md:text-xl leading-relaxed">
          Bridging the gap between sports enthusiasts and turf owners.
        </p>
        <div className="p-8 rounded-2xl bg-slate-900/40 border border-slate-800 backdrop-blur-sm max-w-sm mx-auto shadow-xl">
          ...
          <p className="text-slate-400 text-sm">
            Learn more about our team and journey soon.
          </p>
        </div>
      </div>
    </Container>
